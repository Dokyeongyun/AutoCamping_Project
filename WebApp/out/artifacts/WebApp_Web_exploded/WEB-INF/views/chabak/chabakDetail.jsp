...
<div class="container chabakMain_Container">
    ...
    <div class="cbj_detail_top">
        <div class="cbj_detail_top_upper">
            <p class="cbj_placeName_txt">${chabakDetail.placeName}</p>
        </div>
    ...
    <div class="cbj_detail_bottom">
        ...
        <div class="cbj_detail_img_region">
            <img src="${chabakDetail.filePath}" class="cbj_detail_img"/>
        ...
        <div class="cbj_detail_info_region">
            <table class="cbj_detail_info_table">
                <tr style="border-top: 2px solid #2999ac">
                    <th>장소명</th>
                    <td>${chabakDetail.placeName}</td>
                </tr>
                <tr>
                    <th>주소</th>
                    <td>${chabakDetail.address}</td>
                </tr>
                <tr>
                    <th>전화번호</th>
                    <td>${chabakDetail.phone_number}</td>
                </tr>
                <tr>
                    <th>소갯말</th>
                    <td>${chabakDetail.introduce}</td>
                </tr>
                <tr>
                    <th>평점</th>
                    <td>${chabakDetail.avg_point} / 5.0 점 (${reviewList.size()})</td>
                </tr>
                <tr>
                    <th>이 차박지를 찜한 사람</th>
                    <td>${chabakDetail.jjim} 명</td>
                </tr>
            </table>
        </div>
    </div>
...
<script>
    ...
    // 차박지 위치
    var placePosition = new kakao.maps.LatLng(${chabakDetail.latitude}, ${chabakDetail.longitude});
    ...
    var content = '<div class="customoverlay">' +
        ...
        '    <span class="title">${chabakDetail.placeName}</span>' +
        '  </a>' +
        '</div>';
